# Variable declarations - Located in this file so that they may be removed from the project along with this file, post-migration

#ITHC Enanbled/Dissabled
variable "ithc_infra" {
  type        = bool

module "cas_ui" {
  ...
  cas_ui_gca_adopt_redirect_certificate     = var.cas_ui_gca_adopt_redirect_certificate
  ...
  cas_ui_public_gca_fqdn                    = var.cas_ui_public_gca_fqdn 
  ...
  hosted_zone_cas_ui_gca                    = var.hosted_zone_cas_ui_gca

output "cas_qa_base_cert_validation_records_required" {
  description = "Details of the cert validation records required for the [env]-cas-QA certificate"
  value       = local.cas_qa_base_cert_validations
}

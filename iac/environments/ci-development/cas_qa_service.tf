module "cas_qa" {
  ...
  cas_qa_adopt_redirect_certificate       = var.cas_qa_adopt_redirect_certificate
  cas_qa_base_cert_attempt_validation     = var.cas_qa_base_cert_attempt_validation
  cas_qa_lb_listener_acm_arn              = module.cat_full.buyer_ui_acm_certificate_arn
  cas_qa_public_cert_attempt_validation   = var.cas_qa_public_cert_attempt_validation
